...
class LoadTool(Tool):
    ...
    def description(self) -> str:
        return "Activate a skill by skill_id"
    ...
    def parameters(self) -> dict:
        return {
            ...
            "properties": {
                "skill_id": {
                    "type": "string",
                    "description": "Canonical skill id to activate",
                }
            },
            "required": ["skill_id"],
        }
    ...
    async def execute(self, **kwargs) -> str:
        ...
        if normalized in active_skills:
            return f"already_active:{normalized}"

        active_skills.append(normalized)
        self._sessions_manager.overwrite(self._session)
        return f"loaded:{normalized}"
